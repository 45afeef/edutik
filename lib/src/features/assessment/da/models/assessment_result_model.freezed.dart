...
mixin _$AssessmentResultModel {
  ...
  double? get scoredMark => throw _privateConstructorUsedError;
...
class _$AssessmentResultModelImpl implements _AssessmentResultModel {
  ...
  @override
  String toString() {
    return 'AssessmentResultModel(studentResponse: $studentResponse, assessmentId: $assessmentId, studentId: $studentId, utmSource: $utmSource, campaign: $campaign, scoredMark: $scoredMark, studentName: $studentName)';
  }
...
abstract class _AssessmentResultModel implements AssessmentResultModel {
  factory _AssessmentResultModel(
      ...
      final String? campaign,
      final double? scoredMark,
      final String? studentName}) = _$AssessmentResultModelImpl;
